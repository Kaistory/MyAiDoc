...
<div class="slide-deck" id="day1-deck">
  <div class="slide-stage">
    <img class="slide-img" id="day1-img" src="Vin%20AI/Day-1/Slide/Screenshot_288.png" alt="Slide 1" />
  </div>
  <div class="slide-controls">
    <button type="button" class="slide-btn" id="day1-prev" aria-label="Slide trước">← Trước</button>
    <span class="slide-counter" id="day1-counter">1 / 38</span>
    <button type="button" class="slide-btn" id="day1-next" aria-label="Slide kế">Sau →</button>
  </div>
...
(function () {
  var total = 38;
  var startNum = 288;
  var basePath = 'Vin%20AI/Day-1/Slide/Screenshot_';
  var current = 0;
  var img = document.getElementById('day1-img');
  var counter = document.getElementById('day1-counter');
  var prevBtn = document.getElementById('day1-prev');
  var nextBtn = document.getElementById('day1-next');
  ...
  function keyHandler(e) {
    if (!document.getElementById('day1-deck')) {
...
Ba paper nền tảng cho mọi thứ học trong Day 1 — Transformer, RLHF, và DPO. PDF nhúng trực tiếp bên dưới (có thể cuộn, zoom, tải về):

<style>
.pdf-ref { border: 1px solid #e3e3e3; border-radius: 10px; padding: 14px; margin: 18px 0; background: #fafafa; }
.pdf-ref h4 { margin: 0 0 4px; font-size: 1.05rem; }
.pdf-ref .pdf-meta { font-size: 0.85rem; color: #555; margin-bottom: 10px; }
.pdf-ref .pdf-meta a { margin-right: 12px; }
.pdf-ref .pdf-frame { width: 100%; height: 70vh; min-height: 480px; border: 1px solid #ddd; border-radius: 6px; background: #fff; }
.pdf-ref .pdf-fallback { font-size: 0.85rem; color: #888; margin-top: 6px; }
</style>

<div class="pdf-ref">
  <h4>1. Attention Is All You Need</h4>
  <div class="pdf-meta">
    Vaswani et al. · 2017 ·
    <a href="https://arxiv.org/abs/1706.03762" target="_blank" rel="noopener">arXiv:1706.03762</a>
    <a href="Vin%20AI/Day-1/References/1706.03762v7.pdf" target="_blank" rel="noopener">Mở PDF ↗</a>
    <a href="Vin%20AI/Day-1/References/1706.03762v7.pdf" download>Tải về ⬇</a>
  </div>
  <p>Giới thiệu kiến trúc <strong>Transformer</strong>, self-attention thay LSTM. Nền móng cho GPT, BERT, Claude, Gemini và toàn bộ thế hệ LLM hiện đại.</p>
  <iframe class="pdf-frame" src="Vin%20AI/Day-1/References/1706.03762v7.pdf#view=FitH" title="Attention Is All You Need PDF"></iframe>
  <div class="pdf-fallback">Trình duyệt không nhúng được? <a href="Vin%20AI/Day-1/References/1706.03762v7.pdf" target="_blank" rel="noopener">Mở PDF trong tab mới</a>.</div>
</div>

<div class="pdf-ref">
  <h4>2. Training language models to follow instructions with human feedback (InstructGPT / RLHF)</h4>
  <div class="pdf-meta">
    Ouyang et al. · 2022 ·
    <a href="https://arxiv.org/abs/2203.02155" target="_blank" rel="noopener">arXiv:2203.02155</a>
    <a href="Vin%20AI/Day-1/References/2203.02155v1.pdf" target="_blank" rel="noopener">Mở PDF ↗</a>
    <a href="Vin%20AI/Day-1/References/2203.02155v1.pdf" download>Tải về ⬇</a>
  </div>
  <p>Cách OpenAI dùng <strong>RLHF</strong> biến base model GPT-3 thành instruct model biết "trò chuyện" theo ý người. Mở đường cho ChatGPT.</p>
  <iframe class="pdf-frame" src="Vin%20AI/Day-1/References/2203.02155v1.pdf#view=FitH" title="InstructGPT PDF"></iframe>
  <div class="pdf-fallback">Trình duyệt không nhúng được? <a href="Vin%20AI/Day-1/References/2203.02155v1.pdf" target="_blank" rel="noopener">Mở PDF trong tab mới</a>.</div>
</div>

<div class="pdf-ref">
  <h4>3. Direct Preference Optimization (DPO)</h4>
  <div class="pdf-meta">
    Rafailov et al. · 2023 ·
    <a href="https://arxiv.org/abs/2305.18290" target="_blank" rel="noopener">arXiv:2305.18290</a>
    <a href="Vin%20AI/Day-1/References/2305.18290v3.pdf" target="_blank" rel="noopener">Mở PDF ↗</a>
    <a href="Vin%20AI/Day-1/References/2305.18290v3.pdf" download>Tải về ⬇</a>
  </div>
  <p>Thay <strong>PPO</strong> (RLHF cổ điển) bằng một loss đơn giản hơn, không cần reward model riêng. Đang dần trở thành chuẩn mới cho alignment.</p>
  <iframe class="pdf-frame" src="Vin%20AI/Day-1/References/2305.18290v3.pdf#view=FitH" title="DPO PDF"></iframe>
  <div class="pdf-fallback">Trình duyệt không nhúng được? <a href="Vin%20AI/Day-1/References/2305.18290v3.pdf" target="_blank" rel="noopener">Mở PDF trong tab mới</a>.</div>
</div>

> 💡 **Mẹo đọc paper**
>
> Đừng đọc tuyến tính. Lần lượt: **Abstract → Conclusion → Figures → Method → (Related Work cuối cùng)**. Ba paper này khá dày, nhưng *Attention Is All You Need* chỉ ~10 trang và đáng đọc cả nhất.

### Tài liệu mở rộng (đã trỏ trong bài)

- [The Illustrated Transformer](https://jalammar.github.io/illustrated-transformer/) — Jay Alammar (visual hoá self-attention)
- [State of GPT](https://www.youtube.com/watch?v=bZQun8Y4L2A) — Andrej Karpathy (giải thích pipeline 3 pha rất rõ)
- Anthropic / OpenAI / Google API quickstarts — đọc trực tiếp docs gốc
